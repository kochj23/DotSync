...
class AIBackendManager: ObservableObject {
    ...
    private static let keychainService = "com.jordankoch.DotSync"
    ...
    /// Migrate a single key from UserDefaults to Keychain
    private func migrateKeyToKeychain(defaultsKey: String, keychainAccount: String) {
        let defaults = UserDefaults.standard
        if let legacyValue = defaults.string(forKey: defaultsKey), !legacyValue.isEmpty {
            saveToKeychain(account: keychainAccount, value: legacyValue)
            defaults.removeObject(forKey: defaultsKey)
            NSLog("[AIBackend] Migrated %@ from UserDefaults to Keychain", keychainAccount)
        }
    }
    ...
    private func loadConfiguration() {
        ...
        // Server URLs (non-sensitive, OK in UserDefaults)
        ...
        migrateKeyToKeychain(defaultsKey: "AIBackend_OpenAI_Key", keychainAccount: "AIBackend_OpenAI_Key")
        migrateKeyToKeychain(defaultsKey: "AIBackend_GoogleCloud_Key", keychainAccount: "AIBackend_GoogleCloud_Key")
        migrateKeyToKeychain(defaultsKey: "AIBackend_Azure_Key", keychainAccount: "AIBackend_Azure_Key")
        migrateKeyToKeychain(defaultsKey: "AIBackend_Azure_Endpoint", keychainAccount: "AIBackend_Azure_Endpoint")
        migrateKeyToKeychain(defaultsKey: "AIBackend_AWS_AccessKey", keychainAccount: "AIBackend_AWS_AccessKey")
        migrateKeyToKeychain(defaultsKey: "AIBackend_AWS_SecretKey", keychainAccount: "AIBackend_AWS_SecretKey")
        migrateKeyToKeychain(defaultsKey: "AIBackend_IBM_Key", keychainAccount: "AIBackend_IBM_Key")
        migrateKeyToKeychain(defaultsKey: "AIBackend_IBM_URL", keychainAccount: "AIBackend_IBM_URL")

        // Cloud API Keys (loaded from Keychain)
        openAIAPIKey = loadFromKeychain(account: "AIBackend_OpenAI_Key") ?? ""
        googleCloudAPIKey = loadFromKeychain(account: "AIBackend_GoogleCloud_Key") ?? ""
        azureAPIKey = loadFromKeychain(account: "AIBackend_Azure_Key") ?? ""
        azureEndpoint = loadFromKeychain(account: "AIBackend_Azure_Endpoint") ?? ""
        awsAccessKey = loadFromKeychain(account: "AIBackend_AWS_AccessKey") ?? ""
        awsSecretKey = loadFromKeychain(account: "AIBackend_AWS_SecretKey") ?? ""
        awsRegion = defaults.string(forKey: "AIBackend_AWS_Region") ?? "us-east-1"
        ibmWatsonAPIKey = loadFromKeychain(account: "AIBackend_IBM_Key") ?? ""
        ibmWatsonURL = loadFromKeychain(account: "AIBackend_IBM_URL") ?? ""
    ...
    func saveConfiguration() {
        ...
        saveToKeychain(account: "AIBackend_OpenAI_Key", value: openAIAPIKey)
        saveToKeychain(account: "AIBackend_GoogleCloud_Key", value: googleCloudAPIKey)
        saveToKeychain(account: "AIBackend_Azure_Key", value: azureAPIKey)
        saveToKeychain(account: "AIBackend_Azure_Endpoint", value: azureEndpoint)
        saveToKeychain(account: "AIBackend_AWS_AccessKey", value: awsAccessKey)
        saveToKeychain(account: "AIBackend_AWS_SecretKey", value: awsSecretKey)
        defaults.set(awsRegion, forKey: "AIBackend_AWS_Region")
        saveToKeychain(account: "AIBackend_IBM_Key", value: ibmWatsonAPIKey)
        saveToKeychain(account: "AIBackend_IBM_URL", value: ibmWatsonURL)
